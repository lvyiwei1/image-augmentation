...
for i in range(0,2000):
    ...
    for j in range(putlen):
        bpl += '0'
    for ii in range(5):
        filenames.append('CLEVR_test_'+bpl+str(i)+'_'+str(ii)+'.png')

for fn in filenames:
    randomNoise('images/'+fn, 'noise/'+fn, 10)
    r = random.randint(-40,40)
    darkenlighten('images/'+fn, 'light-dark/'+fn, r)
    blackbox('images/'+fn, 'box/'+fn, 15)
    print(fn)
